...
Normally, when running the Discord client under Wayland, the AFK detection will _never_ fire. **_EVER._** This means (among other things) that you won't receive mobile notifications while the client is open under Wayland, which is incredibly frustrating.
